        ...
        <div className='Home-about'>
          <div className='Home-content'>
            <div className='Home-content-text'>
              ...
              <p className='text-color-light'>Web developer previously in game development. A passionate, motivated creator building accessible, stunning, and high quality products.</p>
            </div>
